...
<body class="fix-header">
    ...
    <div id="main-wrapper">
        ...
        <div class="header">
            ...
            <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/icn.jpg"  height="80" width="80" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
        ...
        <div class="page-wrapper">
					 ...
					 <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Branch Category</h4>
                            </div>
         ...
         <footer class="footer"> © 2022 - Premvati Food Pvt.Ltd</footer>
